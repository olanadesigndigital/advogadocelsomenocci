    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center border border-input bg-background px-5 py-3 text-sm font-medium text-foreground transition-colors hover:bg-accent"
          >
            Ir para o início
          </a>
        </div>
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: site.office,
          description:
            "Escritório de advocacia especializado em Direito do Trabalho, atendendo trabalhadores e empresas.",
